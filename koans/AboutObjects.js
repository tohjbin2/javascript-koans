describe("About Objects", function () {
  ...
  /* array.join() 메서드: ----------  
  해당 메서드에 관한 정보는 AboutFunctions.js에 주석으로 정리했다. */
  ...
  describe("'in' keyword", function () {
    ...
    it("should have the bomb", function () {
      ...
      // MEMO: 아래 답: "theBomb" in megalomaniac는 존재하므로, true를 반환한다. in은 존재 유무(true, false)만을 반환한다 ???
    ...
    it("should not have the detonator however", function () {
      ...
      // MEMO: 아래 답: "theDetonator" in megalomaniac는 존재하지 않으므로, false를 반환한다. ->이게 맞는 해석인지???
  ...
  it("should use prototype to add to all objects", function () {
      ...
      // MEMO: 아래와 같은 방식으로 기존에 없던 객체???라도 추가가 가능하다. (여기서는 colour에 해당)
